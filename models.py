from sqlalchemy import Boolean,String,Column,Integer,ForeignKey,DECIMAL,Float,Numeric,NCHAR,Date
...
class DemandeModel(Base):
    ...
    gestion = Column(Date, nullable=False)  # Matching String type
